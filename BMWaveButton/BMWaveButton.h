...
@property (nonatomic,assign) CGFloat borderSize; // 默认边框大小 3.0
@property (strong, nonatomic) UIColor *waveColor; // 波纹颜色默认白色

@property (nonatomic,assign) NSInteger timeInterval; // 间隔默认 45 、35
@property (nonatomic,assign) CGFloat waveDuration; // 默认 4.0

@property (nonatomic,assign) BOOL displayShading; //是否支持显示阴影
@property (nonatomic,assign) BMWaveButtonType myButtonType; // 类型
